...
namespace RealEstateModule.Services.Import
{
    class ImportRealEstateBook : RealEstateExcelBook
    {
        ...
        private NaturalBuilding InitalizeNaturalBuildingValue(int rowIndex, object[,] allItem)
        {
            ...
            columnIndex++;
            NaturalBuilding.JZWGD = columnIndex < colCount ? double.Parse(GetString(allItem[rowIndex, columnIndex])) : 0.0;
            columnIndex++;
            NaturalBuilding.ZZDMJ = columnIndex < colCount ? double.Parse(GetString(allItem[rowIndex, columnIndex])) : 0.0;
            columnIndex++;
            NaturalBuilding.ZYDMJ = columnIndex < colCount ? double.Parse(GetString(allItem[rowIndex, columnIndex])) : 0.0;
            columnIndex++;
            NaturalBuilding.YCJZMJ = columnIndex < colCount ? double.Parse(GetString(allItem[rowIndex, columnIndex])) : 0.0;
            columnIndex++;
            NaturalBuilding.SCJZMJ = columnIndex < colCount ? double.Parse(GetString(allItem[rowIndex, columnIndex])) : 0.0;
            columnIndex++;
            ...
            columnIndex++;
            NaturalBuilding.DXSD = columnIndex < colCount ? double.Parse(GetString(allItem[rowIndex, columnIndex])) : 0.0;
            columnIndex++;
        ...
        private LogicalBuilding InitalizeLogicalBuildingValue(int rowIndex, object[,] allItem)
        {
            ...
            columnIndex++;
            LogicalBuilding.YCJZMJ = columnIndex < colCount ? double.Parse(GetString(allItem[rowIndex, columnIndex])) : 0.0;
            columnIndex++;
            LogicalBuilding.YCDXMJ = columnIndex < colCount ? double.Parse(GetString(allItem[rowIndex, columnIndex])) : 0.0;
            columnIndex++;
            LogicalBuilding.YCQTMJ = columnIndex < colCount ? double.Parse(GetString(allItem[rowIndex, columnIndex])) : 0.0;
            columnIndex++;
            LogicalBuilding.SCJZMJ = columnIndex < colCount ? double.Parse(GetString(allItem[rowIndex, columnIndex])) : 0.0;
            columnIndex++;
            LogicalBuilding.SCDXMJ = columnIndex < colCount ? double.Parse(GetString(allItem[rowIndex, columnIndex])) : 0.0;
            columnIndex++;
            LogicalBuilding.SCQTMJ = columnIndex < colCount ? double.Parse(GetString(allItem[rowIndex, columnIndex])) : 0.0;
            columnIndex++;
            LogicalBuilding.JGRQ = columnIndex < colCount ? DateTime.Parse(allItem[rowIndex, columnIndex].ToString()) : new DateTime();
            columnIndex++;
        ...
        private Floor InitalizeFloorValue(int rowIndex, object[,] allItem)
        {
            ...
            columnIndex++;
            Floor.CJZMJ = columnIndex < colCount ? double.Parse(GetString(allItem[rowIndex, columnIndex])) : 0.0;
            columnIndex++;
            Floor.CTNJZMJ = columnIndex < colCount ? double.Parse(GetString(allItem[rowIndex, columnIndex])) : 0.0;
            columnIndex++;
            Floor.CYTMJ = columnIndex < colCount ? double.Parse(GetString(allItem[rowIndex, columnIndex])) : 0.0;
            columnIndex++;
            Floor.CGYJZMJ = columnIndex < colCount ? double.Parse(GetString(allItem[rowIndex, columnIndex])) : 0.0;
            columnIndex++;
            Floor.CFTJZMJ = columnIndex < colCount ? double.Parse(GetString(allItem[rowIndex, columnIndex])) : 0.0;
            columnIndex++;
            Floor.CBQMJ = columnIndex < colCount ? double.Parse(GetString(allItem[rowIndex, columnIndex])) : 0.0;
            columnIndex++;
            Floor.CG = columnIndex < colCount ? double.Parse(GetString(allItem[rowIndex, columnIndex])) : 0.0;
            columnIndex++;
            Floor.SPTYMJ = columnIndex < colCount ? double.Parse(GetString(allItem[rowIndex, columnIndex])) : 0.0;
            return Floor;
        ...
        private Household InitalizeHouseholdValue(int rowIndex, object[,] allItem)
        {
            ...
            columnIndex++;
            Household.YCJZMJ = columnIndex < colCount ? double.Parse(GetString(allItem[rowIndex, columnIndex])) : 0.0;
            columnIndex++;
            Household.YCTNJZMJ = columnIndex < colCount ? double.Parse(GetString(allItem[rowIndex, columnIndex])) : 0.0;
            columnIndex++;
            Household.YCFTJZMJ= columnIndex < colCount ? double.Parse(GetString(allItem[rowIndex, columnIndex])) : 0.0;
            columnIndex++;
            Household.YCDXBFJZMJ = columnIndex < colCount ? double.Parse(GetString(allItem[rowIndex, columnIndex])) : 0.0;
            columnIndex++;
            Household.YCQTJZMJ= columnIndex < colCount ? double.Parse(GetString(allItem[rowIndex, columnIndex])) : 0.0;
            columnIndex++;
            Household.YCFTXS = columnIndex < colCount ? GetString(allItem[rowIndex, columnIndex]) : "";
            columnIndex++;
            Household.SCJZMJ = columnIndex < colCount ? double.Parse(GetString(allItem[rowIndex, columnIndex])) : 0.0;
            columnIndex++;
            Household.SCTNJZMJ = columnIndex < colCount ? double.Parse(GetString(allItem[rowIndex, columnIndex])) : 0.0;
            columnIndex++;
            Household.SCFTJZMJ= columnIndex < colCount ? double.Parse(GetString(allItem[rowIndex, columnIndex])) : 0.0;
            columnIndex++;
            Household.SCDXBFJZMJ = columnIndex < colCount ? double.Parse(GetString(allItem[rowIndex, columnIndex])) : 0.0;
            columnIndex++;
            Household.SCQTJZMJ = columnIndex < colCount ? double.Parse(GetString(allItem[rowIndex, columnIndex])) : 0.0;
            columnIndex++;
            Household.SCFTXS= columnIndex < colCount ? GetString(allItem[rowIndex, columnIndex]) : "";
            columnIndex++;
            Household.GYTDMJ= columnIndex < colCount ? double.Parse(GetString(allItem[rowIndex, columnIndex])) : 0.0;
            columnIndex++;
            Household.FTTDMJ= columnIndex < colCount ? double.Parse(GetString(allItem[rowIndex, columnIndex])) : 0.0;
            columnIndex++;
            Household.DYTDMJ = columnIndex < colCount ? double.Parse(GetString(allItem[rowIndex, columnIndex])) : 0.0;
            columnIndex++;
            ...
            columnIndex++;
            Household.JGSJ = columnIndex < colCount ? DateTime.Parse(allItem[rowIndex, columnIndex].ToString()) : new DateTime();
            columnIndex++;
        ...
        private Obligee InitalizebligeeBValue(int rowIndex, object[,] allItem)
        {
            ...
            columnIndex++;
            Obligee.QLMJ = columnIndex < colCount ? double.Parse(GetString(allItem[rowIndex, columnIndex])) : 0.0;
            columnIndex++;
