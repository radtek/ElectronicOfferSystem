...
namespace RealEstateModule.Services.Import
{
    class ImportRealEstateBook : RealEstateExcelBook
    {
        ...
        private Floor InitalizeFloorValue(int rowIndex, object[,] allItem)
        {
            ...
            columnIndex++;
            Floor.CJZMJ = columnIndex < colCount ? GetString(allItem[rowIndex, columnIndex]) : "";
            columnIndex++;
            Floor.CTNJZMJ = columnIndex < colCount ? GetString(allItem[rowIndex, columnIndex]) : "";
            columnIndex++;
            Floor.CYTMJ = columnIndex < colCount ? GetString(allItem[rowIndex, columnIndex]) : "";
            columnIndex++;
            Floor.CGYJZMJ = columnIndex < colCount ? GetString(allItem[rowIndex, columnIndex]) : "";
            columnIndex++;
            Floor.CFTJZMJ = columnIndex < colCount ? GetString(allItem[rowIndex, columnIndex]) : "";
            columnIndex++;
            Floor.CBQMJ = columnIndex < colCount ? GetString(allItem[rowIndex, columnIndex]) : "";
            columnIndex++;
            Floor.CG = columnIndex < colCount ? GetString(allItem[rowIndex, columnIndex]) : "";
            columnIndex++;
            Floor.SPTYMJ = columnIndex < colCount ? GetString(allItem[rowIndex, columnIndex]) : "";
            return Floor;
        ...
        private Household InitalizeHouseholdValue(int rowIndex, object[,] allItem)
        {
            ...
            columnIndex++;
            Household.YCJZMJ = columnIndex < colCount ? GetString(allItem[rowIndex, columnIndex]) : "";
            columnIndex++;
            Household.YCTNJZMJ = columnIndex < colCount ? GetString(allItem[rowIndex, columnIndex]) : "";
            columnIndex++;
            Household.YCFTJZMJ= columnIndex < colCount ? GetString(allItem[rowIndex, columnIndex]) : "";
            columnIndex++;
            Household.YCDXBFJZMJ = columnIndex < colCount ? GetString(allItem[rowIndex, columnIndex]) : "";
            columnIndex++;
            Household.YCQTJZMJ= columnIndex < colCount ? GetString(allItem[rowIndex, columnIndex]) : "";
            columnIndex++;
            Household.YCFTXS = columnIndex < colCount ? GetString(allItem[rowIndex, columnIndex]) : "";
            columnIndex++;
            Household.SCJZMJ = columnIndex < colCount ? GetString(allItem[rowIndex, columnIndex]) : "";
            columnIndex++;
            Household.SCTNJZMJ = columnIndex < colCount ? GetString(allItem[rowIndex, columnIndex]) : "";
            columnIndex++;
            Household.SCFTJZMJ= columnIndex < colCount ? GetString(allItem[rowIndex, columnIndex]) : "";
            columnIndex++;
            Household.SCDXBFJZMJ = columnIndex < colCount ? GetString(allItem[rowIndex, columnIndex]) : "";
            columnIndex++;
            Household.SCQTJZMJ = columnIndex < colCount ? GetString(allItem[rowIndex, columnIndex]) : "";
            columnIndex++;
            Household.SCFTXS= columnIndex < colCount ? GetString(allItem[rowIndex, columnIndex]) : "";
            columnIndex++;
            Household.GYTDMJ= columnIndex < colCount ? GetString(allItem[rowIndex, columnIndex]) : "";
            columnIndex++;
            Household.FTTDMJ= columnIndex < colCount ? GetString(allItem[rowIndex, columnIndex]) : "";
            columnIndex++;
            Household.DYTDMJ = columnIndex < colCount ? GetString(allItem[rowIndex, columnIndex]) : "";
            columnIndex++;
